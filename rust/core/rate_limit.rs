// rust/core/rate_limit.rs — Sliding-window keyed rate limiter
// Pure Rust, no napi dependencies.

use crate::core::hashing::fast_hash_bytes;
use lru::LruCache;
...
/// Sliding-window keyed rate limiter.
///
/// Uses a sharded LRU cache for concurrent access with minimal contention.
...
impl KeyedRateLimiter {
    ...
    /// * `max_entries` - Maximum number of tracked keys (defaults to 1_048_576).
    ...
    /// Check if the given key is rate-limited at the given timestamp.
