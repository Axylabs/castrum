...
export function nativeBunHmacSha256(
  key: Uint8Array,
  data: Uint8Array,
): Uint8Array {
 ...
 */
export function nativeBunPasswordHash(
  password: Uint8Array,
  _salt: Uint8Array,
): string {
 ...
 */
export function nativeBunPasswordHashBcrypt(
  password: Uint8Array,
  cost: number,
): string {
  if (typeof Bun === "undefined") return "";
...
export function bunBcryptHashForVerify(
  password: Uint8Array,
  cost: number,
): string {
...
export function nativeBunPasswordVerifyBcrypt(
  password: Uint8Array,
  cost: number,
): boolean {
  if (typeof Bun === "undefined") return false;
