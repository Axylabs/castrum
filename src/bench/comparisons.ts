...
export const comparisonReports: ComparisonReport[] = [
  ...
  { label: "Media type parse", nativeName: "native:media_type_parse", rustName: "rust:media_type_parse" },
  ...
  { label: "Accept-Encoding negotiate", nativeName: "native:accept_negotiate", rustName: "rust:accept_negotiate" },
  ...
  { label: "Hex encode (pooled)", nativeName: "native:hex_encode", rustName: "rust:hex_encode_into" },
  ...
  { label: "URL query build", nativeName: "native:url_encode_query", rustName: "rust:url_encode_query" },
  ...
  { label: "URL encode (pooled)", nativeName: "native:url_encode", rustName: "rust:url_encode_into" },
  { label: "URL decode (pooled)", nativeName: "native:url_decode", rustName: "rust:url_decode_into" },
  ...
  { label: "Template render (bytes)", nativeName: "native:template_render", rustName: "rust:template_render_bytes" },
  ...
  { label: "Form parse (batch 100)", nativeName: "native:form_parse_batch", rustName: "rust:form_parse_batch" },
  ...
  { label: "FNV-1a 64 vs Bun.hash (wyhash)", nativeName: "diag:bun_hash_wyhash", rustName: "diag:fnv1a64" },
  ...
  { label: "HMAC-SHA256 vs Bun.CryptoHasher", nativeName: "diag:bun_hmac_sha256", rustName: "diag:hmac_sha256" },
  { label: "Password hash vs Bun.password.argon2id", nativeName: "diag:bun_password_hash", rustName: "diag:password_hash" },
  { label: "Password verify vs Bun.password.verify", nativeName: "diag:bun_password_verify", rustName: "diag:password_verify" },
  { label: "Password hash (bcrypt) vs Bun.password.bcrypt", nativeName: "diag:bun_password_bcrypt_hash", rustName: "diag:bcrypt_hash" },
  { label: "Password verify (bcrypt) vs Bun.password.bcrypt", nativeName: "diag:bun_password_bcrypt_verify", rustName: "diag:bcrypt_verify" },
  { label: "PBKDF2-HMAC-SHA256 vs node:crypto pbkdf2Sync", nativeName: "diag:pbkdf2_sha256", rustName: "diag:pbkdf2_sha256_rust" },
  { label: "Random token vs Bun.randomUUIDv7", nativeName: "diag:bun_random_uuidv7", rustName: "diag:random_token16" },
  { label: "Gzip compress vs Bun.gzipSync", nativeName: "diag:bun_gzip_compress", rustName: "diag:gzip_compress" },
  { label: "Gzip decompress vs Bun.gunzipSync", nativeName: "diag:bun_gzip_decompress", rustName: "diag:gzip_decompress" },
];