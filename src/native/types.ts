...
//
// The per-class INSTANCE types live in ./types/instances.ts. They are imported
// here (so `NativeAddon` can reference them) and re-exported so existing
// `import { X } from '../native/types'` call sites keep working.
...
export interface NativeAddon {
  ...
  gzipDecompressBatchPacked(data: Uint8Array, maxDecompressed?: number | null): Uint8Array
  brotliCompressBatchPacked(data: Uint8Array, quality?: number | null): Uint8Array
  brotliDecompressBatchPacked(data: Uint8Array, maxDecompressed?: number | null): Uint8Array
  ...
  jwtVerifyBatchPacked(data: Uint8Array, secret: Uint8Array, nowSeconds: number): Uint8Array
  ...
  JwtSigner: new (secret: Uint8Array, ttlSeconds?: number | null) => JwtSignerInstance
  AeadCipher: new (key: Uint8Array, algorithm?: string | null) => AeadCipherInstance
  Argon2Hasher: new (options?: PasswordHashOptions | null) => Argon2HasherInstance
