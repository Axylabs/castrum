...
export const PROVEN_SURFACE = [
  ...
  { name: "httpDate", label: "HTTP date", nativeTask: "native:http_date", rustTask: "rust:http_date", status: "not-competitive", note: "Date.toUTCString() is native (~1.5-1.7x loss); pooled httpDateInto cuts it to ~1.3x." },
